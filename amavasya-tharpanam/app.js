// Amavasya Tharpanam Application
// ================================
...
(function () {
  ...
  function renderIntro() {
    ...
    container.textContent = THARPANAM_DATA.intro;
  }

  // --- Render Traditions Note ---
  function renderTraditions() {
    var container = document.getElementById('traditions-content');
    if (THARPANAM_DATA.traditions) {
      container.textContent = THARPANAM_DATA.traditions;
    }
  }
  ...
  function renderItems() {
    ...
    if (THARPANAM_DATA.requiredItems) {
      var html = '';
      THARPANAM_DATA.requiredItems.forEach(function (item) {
  ...
  function buildMantraHtml(mantra) {
    ...
    if (mantra.instruction) {
      html += '<div class="mantra-instruction">' + escapeHtml(mantra.instruction) + '</div>';
    }
  ...
  function buildSectionCard(section) {
    ...
    if (section.procedure) {
      mantrasHtml += '<div class="section-procedure"><strong>Procedure:</strong> ' + escapeHtml(section.procedure) + '</div>';
    }
  ...
  function renderSections() {
    ...
    var html = '';
    THARPANAM_DATA.sections.forEach(function (section) {
      ...
      searchTimer = setTimeout(function () {
        ...
        THARPANAM_DATA.sections.forEach(function (section) {
          ...
          section.mantras.forEach(function (mantra) {
            ...
            if (textMatch || devanagariMatch || meaningMatch || instructionMatch || sectionMatch) {
              matches.push({
